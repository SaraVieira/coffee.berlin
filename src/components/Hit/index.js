...
const Hit = ({ hit }) => (
  <div key={hit.id}>
    <div class="max-w-sm rounded overflow-hidden shadow-lg">
      ...
      <div class="px-6 py-4">
        <div class="font-bold text-xl mb-2">{hit.name}</div>
        <p class="text-gray-700 text-base flex items-center">
          ...
          >
            <g>
              <path
                fill={hit.rating > 2.5 ? "#F6E05E" : "#4a5568"}
              ...
              ></path>
              <path
                fill={hit.rating > 8.5 ? "#F6E05E" : "#4a5568"}
              ...
              <path
                fill={hit.rating > 5 ? "#F6E05E" : "#4a5568"}
          ...
          <span className="font-bold ml-2">
            Rating: <span className="font-normal">{hit.rating}</span>
          </span>
        </p>
        <p class="text-gray-700 text-base flex items-center">
          <svg
          ...
          <span className="font-bold ml-2">
            ...
            <span className="font-normal">
              {
                hit.attributes.groups.find(attr => attr.type === "price")
                  .summary
              }
            </span>
          </span>
        ...
        <p class="text-gray-700 text-base flex items-center">
          ...
          >
            <g>
              <g>
                <g>
                  <path d="M20.5,23c-9.9,0-18,8-18,18c0,7.8,11.1,22.3,15.8,28.2c1.1,1.4,3.2,1.4,4.3,0c4.8-5.9,15.8-20.4,15.8-28.2     C38.5,31.1,30.4,23,20.5,23z M20.5,48.8c-4.3,0-7.8-3.5-7.8-7.8c0-4.3,3.5-7.8,7.8-7.8s7.8,3.5,7.8,7.8     C28.3,45.3,24.8,48.8,20.5,48.8z"></path>
                  <path d="M79.5,23c-9.9,0-18,8-18,18c0,7.8,11.1,22.3,15.8,28.2c1.1,1.4,3.2,1.4,4.3,0c4.8-5.9,15.8-20.4,15.8-28.2     C97.5,31.1,89.5,23,79.5,23z M79.5,48.8c-4.3,0-7.8-3.5-7.8-7.8c0-4.3,3.5-7.8,7.8-7.8c4.3,0,7.8,3.5,7.8,7.8     C87.3,45.3,83.8,48.8,79.5,48.8z"></path>
                  <path d="M62.3,62.1c-0.8-0.8-2.2-0.8-3,0c-0.8,0.8-0.8,2.2,0,3l2,2H38.7l2-2c0.8-0.8,0.8-2.2,0-3c-0.8-0.8-2.2-0.8-3,0L32,67.7     c-0.8,0.8-0.8,2.2,0,3l5.6,5.6c0.4,0.4,1,0.6,1.5,0.6c0.5,0,1.1-0.2,1.5-0.6c0.8-0.8,0.8-2.2,0-3l-2-2h22.7l-2,2     c-0.8,0.8-0.8,2.2,0,3c0.4,0.4,1,0.6,1.5,0.6c0.5,0,1.1-0.2,1.5-0.6l5.6-5.6c0.8-0.8,0.8-2.2,0-3L62.3,62.1z"></path>
                </g>
              </g>
            </g>
          </svg>
          ...
          <span className="font-bold ml-2">
            Distance:{" "}
            <span className="font-normal">
              {(hit._rankingInfo.geoDistance / 1000).toFixed(1)}km
            </span>
          </span>
        </p>
      </div>
